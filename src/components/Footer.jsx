      ...
      <div className="team-section">
        ...
        <div className="team-members">
          <div className="member-card">
            ...
            📧 <a href="mailto:anchal@example.com">anchal@example.com</a><br />
            🔗 <a href="https://www.linkedin.com/in/anchalchaurasiya" target="_blank" rel="noopener noreferrer">LinkedIn</a> | 
            📸 <a href="https://www.instagram.com/anchalchaurasiya" target="_blank" rel="noopener noreferrer">Instagram</a>
          </div>
          <div className="member-card">
